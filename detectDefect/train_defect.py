...
class BalloonConfig(Config):
    ...
    # Skip detections with < 97% confidence
...
def train(model):
    ...
    augmentation=imgaug.augmenters.Sometimes(5/6,imgaug.augmenters.OneOf(
                                            ...
                                            imgaug.augmenters.Affine(rotate=(-2.5, 2.5)), 
                                            imgaug.augmenters.Affine(rotate=(-5, 5)), 
                                            imgaug.augmenters.Affine(scale=(0.5, 1.5)),
                                            imgaug.augmenters.Multiply((0.5, 1.5))  # brightness
                                             ]))
    ...
    model.train(dataset_train, dataset_val,
                ...
                epochs=30,
                layers='3+',                    # transfer learning resnet101 3th layer (default 'heads')
...
def color_splash(image, mask):
    ...
    if mask.shape[-1] > 0:
        ...
        # depending on mask, chose image or gray
    else:
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        ...
        for img in images:
            ...
            detect_and_color_splash(model, image_path=imgname, video_path=args.video)
